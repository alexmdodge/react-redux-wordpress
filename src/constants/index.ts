...
// API URL Options
export const REST_URL = 'https://your.domain/wp-json/wp/v2';
export const BASE_URL = 'https://your.domain';

export const CLIENT_KEY = 'abc123';
export const CLIENT_SECRET = 'abcdef123456';